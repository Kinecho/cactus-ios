...
class SentPromptService {
    ...
    func observeSentPromptsPage(member: CactusMember, limit: Int?=nil, lastResult: PageResult<SentPrompt>?=nil, _ onData: @escaping (PageResult<SentPrompt>) -> Void) -> ListenerRegistration? {
        guard let memberId = member.id else {
